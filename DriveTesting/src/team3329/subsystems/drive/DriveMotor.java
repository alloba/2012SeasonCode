...
/**
 * Required to invert direction on motor output
...
public class DriveMotor implements PIDOutput
{
    ...
    private Jaguar[] m_Jag = new Jaguar[2];
    private Victor[] m_Victor = new Victor[2];
    ...
    //limit the max and min values of a value
