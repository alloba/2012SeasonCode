...
public class Navigation
{
    ...
    private Navigation(CoordinateVector h, Encoder lEncoder, Encoder rEncoder)
    {
        ...
        m_leftEncoder.setDistancePerPulse(RobotProperties.lDistancePerCount);
        m_rightEncoder.setDistancePerPulse(RobotProperties.rDistancePerCount);
    ...
    //returns null if no coordinate is found
    public PolarVector getNextCoordinate()
    {
        PolarVector c = (PolarVector) posCoordinates.pull();
        if(c != null) return c;
            else return null;
    }
    ...
    public PolarVector previewNextCoordinate()
    {
        ...
        PolarVector v = (PolarVector) posCoordinates.search(posCoordinates.length()-1);
